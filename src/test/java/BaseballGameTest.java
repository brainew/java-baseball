...
public class BaseballGameTest {
	...
	void pickNumber_isOk() {
		...
		assertEquals(3, defaultNumbers.size());
	}
	...
	void valid_range_numbers_isOK() {
		...
		for (int inputNumber: userInputNumbers) {
			assertTrue((inputNumber > 0 && inputNumber < 10));
		}
	}
	...
	void valid_numbers_isOK() {
		...
		assertEquals(3, parseNumbers.size());
	}
	...
	void check_ball_strike() {
		...
		assertEquals(0, isBall(defaultNumbers, inputNumbers));
		assertEquals(3, isStrike(defaultNumbers, inputNumbers));
	}
